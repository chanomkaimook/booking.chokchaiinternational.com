...
{
    private $table = "customers_address";
    ...
    public function insert_data($data_insert = null)
    {
        ...
        $item_name = textNull($data_insert['customer_id']) ? $data_insert['customer_id'] : $request['item_name'];
        $item_address = textNull($data_insert['address']) ? $data_insert['address'] : $request['item_address'];
        $array_chk_dup = array(
