...
<head>
    ...
    <!-- Toast -->
    <link href="<?= base_url('') ?>asset/libs/jquery-toast/jquery.toast.min.css" rel="stylesheet" type="text/css" />
...
<body>
    ...
    <!-- Toast -->
    <script src="<?= base_url('') ?>asset/libs/jquery-toast/jquery.toast.min.js"></script>
