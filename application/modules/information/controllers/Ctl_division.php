...
class Ctl_division extends MY_Controller
{
    ...
    {
        parent::__construct();
        $modelname = 'mdl_division';
        $this->load->model(array('information/mdl_division'));
        ...
        $this->title = 'จัดการข้อมูลรุ่นลูกค้า';
    }
    ...
    public function index()
    {
        ...
        $this->template->build('division/index');
    }
