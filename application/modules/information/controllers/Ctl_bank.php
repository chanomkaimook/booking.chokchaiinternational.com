...
class Ctl_bank extends MY_Controller
{
    ...
    public function __construct()
    {
        parent::__construct();
        $modelname = 'mdl_bank';
        $this->load->model(array('information/mdl_bank'));
    ...
    public function index()
    {
        ...
        $this->template->build('bank/index');
    }
    ...
    public function get_dataTable()
    {
        ...
        if ($data) {
            foreach ($data as $row) {
                ...
                $sub_data['NUMBERCARD'] = textNull($row->NUMBERCARD);
